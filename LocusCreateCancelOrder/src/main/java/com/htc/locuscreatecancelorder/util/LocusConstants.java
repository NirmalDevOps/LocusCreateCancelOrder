package com.htc.locuscreatecancelorder.util;
...
public class LocusConstants {
	...
	public static final String ERROR_IN_PROCESSING="Error in processing Locus Request Body";
	
	public static final String CANCEL_SUCCESS_MESSAGE = "Cancelled Successfully";
	public static final String CANCEL_FAILED_MESSAGE = "cancellation failed";
